#ifndef BlueWizard_NotificationNames_h
#define BlueWizard_NotificationNames_h

static NSString * const inputSignalReceived          = @"inputSignalReceived";
static NSString * const playOriginalWasClicked       = @"playOriginalWasClicked";
